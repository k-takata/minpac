...
# Download the latest Vim AppImage from the GitHub release
...
# Repository Name
repo_name = 'vim/vim-appimage'
gh_release_url = 'https://api.github.com/repos/' + repo_name + '/releases/latest'

# Parse arguments
parser = argparse.ArgumentParser(
        description='Download the latest Vim AppImage from the GitHub release')
